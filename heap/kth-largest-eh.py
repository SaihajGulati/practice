class Solution:
    ...
    def findKthLargest(self, nums: List[int], k: int) -> int:
        ...
        #this will be index we want it in henceforth bc index is index + 1 smallest value after each partition as all to left are smaller and all to right are bigger
        k = len(nums) - k
